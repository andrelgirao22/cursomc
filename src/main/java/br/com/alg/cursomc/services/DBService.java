...
public class DBService {
	...
	@Autowired
	private ItemPedidoRepository imItemPedidoRepository;
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Andre Girao", "andrelgirao22@hotmail.com", "36378912377",TipoCliente.PESSOA_FISICA, passwordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "andrelgirao29@gmail.com", "88832282275",TipoCliente.PESSOA_FISICA, passwordEncoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363399","97838393"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "3777012", cli2, c2);
		...
		ItemPedido ip3 = new ItemPedido(ped2, p2, 100.0, 2, 800.0);
		...
		this.imItemPedidoRepository.saveAll(Arrays.asList(ip1, ip2, ip3));
	}
